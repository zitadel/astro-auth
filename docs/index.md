...
hero:
  ...
  actions:
    ...
    - theme: alt
      text: GitHub
      link: https://github.com/zitadel/astro-auth

features:
  - title: OAuth
    details: Effortlessly connect your Astro application with Google, GitHub, Azure and countless others.
  ...
  - title: Made for Astro
    details: Deep integrations with the Astro framework.
